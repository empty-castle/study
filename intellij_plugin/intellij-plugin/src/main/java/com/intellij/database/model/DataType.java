...
public final class DataType implements Serializable {
  ...
  @NotNull
  public DataType withSuffix(@Nullable String suffix) {
    return new DataType(
      schemaName, packageName, typeName, size, scale, sizeUnit,
      sizeUnitExplicit, vagueArg, suffix, custom, enumValues, jdbcType);
  }
  ...
  public String getSpecification(boolean forceDefaults, boolean onlyNumbers) {
    return getSpecification(forceDefaults, onlyNumbers, true);
  }

  @NotNull
  public String getSpecification(boolean forceDefaults, boolean onlyNumbers, boolean withSchema) {
    boolean nothingSpecial = vagueArg == null && enumValues == null && size < 0 && suffix == null;
    if (schemaName == null && packageName == null && nothingSpecial) {
      return typeName;
    }

    StringBuilder sb = new StringBuilder(12);
    if (withSchema && schemaName != null) {
    ...
    if (nothingSpecial) return sb.toString();
  ...
  public boolean equalsWithoutJdbc(@NotNull DataType that) {
    ...
    if (!Objects.equals(vagueArg, that.vagueArg)) return false;
