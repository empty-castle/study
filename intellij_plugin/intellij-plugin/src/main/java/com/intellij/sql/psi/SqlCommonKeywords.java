...
public interface SqlCommonKeywords {
  ...
  SqlTokenType SQL_DISABLE = getType("DISABLE", SqlKeywordTokenType.FACTORY);
  ...
  SqlTokenType SQL_ENABLE = getType("ENABLE", SqlKeywordTokenType.FACTORY);
  ...
  SqlTokenType SQL_MAX = getType("MAX", SqlKeywordTokenType.FACTORY);
  SqlTokenType SQL_MEMBER = getType("MEMBER", SqlKeywordTokenType.FACTORY);
  ...
  SqlTokenType SQL_OBJECT = getType("OBJECT", SqlKeywordTokenType.FACTORY);
  ...
  SqlTokenType SQL_OUTPUT = getType("OUTPUT", SqlKeywordTokenType.FACTORY);
  ...
  SqlTokenType SQL_RECORD = getType("RECORD", SqlKeywordTokenType.FACTORY);
  ...
  SqlTokenType SQL_RETURNING = getType("RETURNING", SqlKeywordTokenType.FACTORY);
  ...
  SqlTokenType SQL_SELF = getType("SELF", SqlKeywordTokenType.FACTORY);
  ...
  SqlTokenType SQL_VARIADIC = getType("VARIADIC", SqlKeywordTokenType.FACTORY);
