...
public final class SqlCodeStyleSettingsDefault {
  ...
  public static final SqlCodeStyleSettingsDefault MODERN =
    new SqlCodeStyleSettingsDefault(
      ...
      /* CUSTOM_TYPE_CASE */                             AS_IDENTIFIERS,
      /* ALIAS_CASE */                                   DO_NOT_CHANGE,
      /* BUILT_IN_CASE */                                AS_KEYWORDS,
      /* QUOTED_IDENTIFIER_CASE */                       DO_NOT_CHANGE,
      /* ORIGINAL_CASE */                                false, // TODO may be true?
      ...
      /* TABLE_ALTER_INSTRUCTION_INDENT */               true,
      /* TABLE_ALTER_INSTRUCTION_ALIGN */                true,
      /* TABLE_ALTER_ITEM_WRAP */                        AS_IS,
      /* TABLE_ALTER_ITEM_INDENT */                      true,
      /* TABLE_ALTER_ITEM_ALIGN */                       true,
      ...
      /* SCRIPT_STMT_SEMICOLON_WRAP */                   AS_IS,
      /* SCRIPT_STMT_FOLLOWS_BLANK_LINE */               AS_IS,
      ...
      /* IMP_DECLARE_ALIGN_LINE_COMMENTS */              false,
  ...
  public static final SqlCodeStyleSettingsDefault LEGACY =
    new SqlCodeStyleSettingsDefault(
      ...
      /* CUSTOM_TYPE_CASE */                             AS_KEYWORDS,
      /* ALIAS_CASE */                                   AS_IDENTIFIERS,
      /* BUILT_IN_CASE */                                DO_NOT_CHANGE,
      /* QUOTED_IDENTIFIER_CASE */                       DO_NOT_CHANGE,
      /* ORIGINAL_CASE */                                false,
      /* QUOTE_IDENTIFIER */                             DO_NOT_CHANGE,
      /* QUOTE_TYPE */                                   QUOTE_AUTO,
      ...
      /* TABLE_COLLAPSE */                               false,
      /* TABLE_ALTER_INSTRUCTION_WRAP */                 ADD,
      /* TABLE_ALTER_INSTRUCTION_INDENT */               false,
      /* TABLE_ALTER_INSTRUCTION_ALIGN */                false,
      /* TABLE_ALTER_ITEM_WRAP */                        AS_IS,
      /* TABLE_ALTER_ITEM_INDENT */                      true,
      /* TABLE_ALTER_ITEM_ALIGN */                       false,
      /* CONSTRAINT_WRAP_1 */                            true,
      /* CONSTRAINT_WRAP_2 */                            false,
      /* CONSTRAINT_WRAP_3 */                            false,
      /* CONSTRAINT_WRAP_4 */                            false,
  ...
  private SqlCodeStyleSettingsDefault(final int KEYWORD_CASE,
                                      final int IDENTIFIER_CASE,
                                      final int TYPE_CASE,
                                      final int CUSTOM_TYPE_CASE,
                                      final int ALIAS_CASE,
                                      final int BUILT_IN_CASE,
                                      final int QUOTED_IDENTIFIER_CASE,
                                      final boolean ORIGINAL_CASE,
                                      ...
                                      final boolean SELECT_ASTERISK_REGULAR,
                                      ...
                                      final boolean TABLE_ALTER_INSTRUCTION_INDENT,
                                      final boolean TABLE_ALTER_INSTRUCTION_ALIGN,
                                      final int TABLE_ALTER_ITEM_WRAP,
                                      final boolean TABLE_ALTER_ITEM_INDENT,
                                      final boolean TABLE_ALTER_ITEM_ALIGN,
                                      ...
                                      final int SCRIPT_STMT_SEMICOLON_WRAP,
                                      final int SCRIPT_STMT_FOLLOWS_BLANK_LINE,
                                      ...
                                      final boolean IMP_DECLARE_ALIGN_LINE_COMMENTS,
    ...
    this.CUSTOM_TYPE_CASE = CUSTOM_TYPE_CASE;
    this.ALIAS_CASE = ALIAS_CASE;
    this.BUILT_IN_CASE = BUILT_IN_CASE;
    this.QUOTED_IDENTIFIER_CASE = QUOTED_IDENTIFIER_CASE;
    this.ORIGINAL_CASE = ORIGINAL_CASE;
    ...
    this.SELECT_ASTERISK_REGULAR = SELECT_ASTERISK_REGULAR;
    ...
    this.TABLE_ALTER_INSTRUCTION_INDENT = TABLE_ALTER_INSTRUCTION_INDENT;
    this.TABLE_ALTER_INSTRUCTION_ALIGN = TABLE_ALTER_INSTRUCTION_ALIGN;
    this.TABLE_ALTER_ITEM_WRAP = TABLE_ALTER_ITEM_WRAP;
    this.TABLE_ALTER_ITEM_INDENT = TABLE_ALTER_ITEM_INDENT;
    this.TABLE_ALTER_ITEM_ALIGN = TABLE_ALTER_ITEM_ALIGN;
    ...
    this.SCRIPT_STMT_SEMICOLON_WRAP = SCRIPT_STMT_SEMICOLON_WRAP;
    this.SCRIPT_STMT_FOLLOWS_BLANK_LINE = SCRIPT_STMT_FOLLOWS_BLANK_LINE;
    ...
    this.IMP_DECLARE_ALIGN_LINE_COMMENTS = IMP_DECLARE_ALIGN_LINE_COMMENTS;
