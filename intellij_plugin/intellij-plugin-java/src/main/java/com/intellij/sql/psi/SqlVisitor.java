...
// visitSqlDefinition(o);
  ...
  public void visitSqlLimitClause(final SqlLimitClause o) { visitSqlElement(o); }

  public void visitSqlOffsetClause(final SqlOffsetClause o) {
    visitSqlElement(o);
  }

  public void visitSqlJoinConditionClause(final SqlJoinConditionClause o) { visitSqlElement(o); }

  public void visitSqlSelectOption(final SqlSelectOption o) { visitSqlElement(o); }
}
